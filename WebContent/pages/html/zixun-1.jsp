...
<a style = "color: white;text-decoration: none" href="zixun/zixun-k1.jsp?id=${zhi.zixunid}"><button type="button" class="btn btn-info">更多</button></a>
